...
<%@include file="../includes/header.jsp" %>
    ...
    <div class="container w-50">
        ...
        <button type="button" class="btn btn-primary " style="width:100px;" id='addReplyBtn'>new reply</button>
        </div>
        	<ul class="list-group chat">
			  <li class="list-group-item d-flex justify-content-between align-items-center" data-rno='12'>
			  <div class="col-md-2">
			  <h6></h6>
			  </div>
			  <div class="col-md-8">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <div class="form-group">
				  ...
				  <input type="text" class="form-control" placeholder="Default input" id="inputDefault" name='reply' value='New Reply!!!'>
				</div>
				<div class="form-group">
				    <label class="col-form-label mt-4" for="inputDefault">Reply</label>
				    <input type="text" class="form-control" placeholder="Default input" id="inputDefault" name='replyer' value='testreplyer'>
				</div>
        		...
        		function showList(page){
        			...
        			replyService.getList({bdnum:bdnumValue,page:page||1},function(replyCnt,list){
        				...
        				for(let i =0, len = list.length||0; i<len;i++){
        					...
        					str+="<div class='col-md-2'><h6>" + list[i].replyer + "</h6></div>";
        					str+="<div class='col-md-9'style='cursor:pointer'>" + list[i].reply + "</div>";
        					str+="<div class='col-md-1'>" + replyService.displayTime(list[i].replyDate) + "</div>";
        				}
        		...
        		function showReplyPage(replyCnt){
        			...
        			let str="<ul class='pagination pagination-sm'>";
        		      ...
        		      if(prev){
        		    	  ...
        		    	  str+="<li class='page-item' id='prev_btn'><a class='page-link' href='"+ (startNum-1) +"'>&laquo;</a></li>";
        		      }
        		      ...
        		      if(next){
        		    	  ...
        		    	  str+="<li class='page-item' id='next_replybtn'><a class='page-link' href='"+ (endNum+1) +"'>&raquo;</a></li>";
        		      }
